  ...
  try {
    ...
    await sql.begin(async (tx: any) => {
      for (const p of persons) {
        await tx`INSERT INTO persons (id,name,role,unit)
      ...
      for (const pr of products) {
        await tx`INSERT INTO products (name,type)
      ...
      for (const a of achievements) {
        await tx`INSERT INTO achievements (id,person_id,product,amount,date)
      ...
      for (const t of targetRows) {
        await tx`INSERT INTO targets (person_id,product,value)
      ...
      for (const al of allowedRows) {
        await tx`INSERT INTO allowed (person_id,product,allowed)
